(function() {
  ...
  BookingsController.$inject = ['bookedHallsResolve', 'CommonService', 'CALENDAR_CHANGE_VIEW', 'eventTypesResolve', 'paymentStatusesResolve', 'taxesResolve', '$scope', '$state', '$rootScope', '$mdDialog', '$mdToast', '$timeout', 'hallsResolve', 'MESSAGES', 'Notification', 'SearchBookingServices', 'HARDCODE_VALUES'];

  function BookingsController(bookedHallsResolve, CommonService, CALENDAR_CHANGE_VIEW, eventTypesResolve, paymentStatusesResolve, taxesResolve, $scope, $state, $rootScope, $mdDialog, $mdToast, $timeout, hallsResolve, MESSAGES, Notification, SearchBookingServices, HARDCODE_VALUES) {
    ...
    $scope.loadinitial = function() {
      ...
      chartSummary($scope.model.newBookings);
    };
