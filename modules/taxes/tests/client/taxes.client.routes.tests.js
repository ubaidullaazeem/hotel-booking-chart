    ...
    describe('Route Config', function () {
      ...
      describe('View Route', function () {
        ...
        it('Should have templateUrl', function () {
          expect(viewstate.templateUrl).toBe('modules/taxes/client/views/view-tax.client.view.html');
        });
      });
      ...
      describe('Create Route', function () {
        ...
        beforeEach(inject(function ($controller, $state, $templateCache) {
          createstate = $state.get('taxes.create');
          $templateCache.put('modules/taxes/client/views/form-tax.client.view.html', '');
        ...
        it('should respond to URL', inject(function ($state) {
          expect($state.href(createstate)).toEqual('/taxes/create');
        }));
        ...
        it('Should have templateUrl', function () {
          expect(createstate.templateUrl).toBe('modules/taxes/client/views/form-tax.client.view.html');
        });
      });
      ...
      describe('Edit Route', function () {
        ...
        beforeEach(inject(function ($controller, $state, $templateCache) {
          editstate = $state.get('taxes.edit');
          $templateCache.put('modules/taxes/client/views/form-tax.client.view.html', '');
        ...
        it('Should have templateUrl', function () {
          expect(editstate.templateUrl).toBe('modules/taxes/client/views/form-tax.client.view.html');
        });
